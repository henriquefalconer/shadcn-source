...
//   2. fonts     -- _work/fetch-fonts.mjs          -> assets/fonts
//   3. icons     -- _work/fetch-simpleicons.mjs    -> assets/cdn.simpleicons.org
//                   + postprocess-simpleicons.mjs
//   4. static    -- _work/fetch-static-assets.mjs  -> picsum, flagcdn, models.dev,
//                                                     jsdelivr, unpkg, raw.githack
//   5. notices   -- _work/gen-notices.mjs          -> assets/NOTICE, assets/fonts/NOTICE
//
...
const WORK = path.join(ARCHIVE, "_work")
...
function run(script, label) {
  const p = path.join(WORK, script)
  if (!fs.existsSync(p)) return { script, skipped: "missing" }
